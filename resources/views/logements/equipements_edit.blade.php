        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-content-wrap">
                ...
                <div class="dashboard-list-box fl-wrap">
                    ...
                    <form action="{{ route('hoost.logements.equipements.update', $logement->id) }}" method="POST"
                        class="custom-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="equipments-grid">
                            @forelse($equipements as $equipement)
                                <div class="equipment-card">
                                    <input class="equipment-checkbox" type="checkbox" name="equipements[]"
                                        value="{{ $equipement->id }}" id="equipment-{{ $equipement->id }}"
                                        {{ in_array($equipement->id, $selected) ? 'checked' : '' }}>

                                    {{-- <div class="equipment-icon">
                                    <i class="fas {{ $equipement->icon ?? 'fa-check' }}"></i>
                                </div> --}}

                                    <label class="equipment-label" for="equipment-{{ $equipement->id }}">
                                        {{ $equipement->libelle }}
                                    </label>
                                </div>
                            @empty
