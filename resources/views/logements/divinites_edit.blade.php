        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-title fl-wrap">
                <div class="dashboard-title-item">
                    <span>Gestion des divinités</span>
                </div>
            ...
            <div class="dashboard-content-wrap">
                ...
                <div class="dashboard-list-box fl-wrap">
                    ...
                    <form action="{{ route('hoost.logements.divinites.update', $logement->id) }}" method="POST"
                        class="custom-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="equipments-grid">
                            @forelse($divinites as $divinite)
                                <div class="equipment-card">
                                    ...
                                    <label class="equipment-label" for="equipment-{{ $divinite->id }}">
                                        {{ $divinite->nom }}
                                    </label>

                                    <input class="equipment-checkbox" type="checkbox" name="divinites[]"
                                        value="{{ $divinite->id }}" id="equipment-{{ $divinite->id }}"
                                        {{ in_array($divinite->id, $selected) ? 'checked' : '' }}>
