    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-title fl-wrap">
                <div class="dashboard-title-item"><span>Ajouter un règlement</span></div>
            ...
            <div class="dasboard-wrapper fl-wrap no-pag">
                ...
                <div class="dasboard-widget-box   fl-wrap">
                    <form action="{{ route('hoost.logements.reglements.store',$logement->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="add_room-container fl-wrap">
                            ...
                            <div class="add_room-item fl-wrap ">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                    <label>Libelle:</label>
                                    <input type="text" name="reglements[]" placeholder="Règlement" required value="" style="text-align:left;padding-left:15px;" />
                                    </div>
                                </div>
                            </div>
                            <!--add_room-item end  -->
