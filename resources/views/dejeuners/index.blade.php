    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-title fl-wrap">
                <div class="dashboard-title-item"><span>Petits déjeuners</span></div>
                ...
                <div class="custom-form">
                    <div class="row">
                        <div class="dasboard-widget-title fl-wrap"
                            ...
                            <h5>Liste des petits déjeuners</h5>
                            ...
                            <button type="button"
                                ...
                                <i class="fas fa-plus"></i> Ajouter un petit déjeuner
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse($dejeuners as $dejeuner)
                                    <tr>
                                        <td style="text-align:left; width:200px;">{{ Str::limit($dejeuner->libelle,100) }}</td>
                                        <td style="text-align:left; width:200px;">
                                            {{ $dejeuner->created_at->format('d/m/Y H:i') }}</td>
                                            ...
                                            <div class="vh-action-dropdown">
                                                ...
                                                <div class="vh-action-menu">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-id="{{ $dejeuner->id}}"
                                                        data-libelle="{{ $dejeuner->libelle}}">
                                                        <i class="fa fa-edit me-2"></i> Modifier
                                                    </a>

                                                    <form
                                                        action="{{ route('hoost.dejeuners.destroy',$dejeuner->id) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('Confirmer la suppression de ce petit déjeuner ?');">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Aucun petit déjeuner enregistré pour le moment.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
...
<div id="vh-point-modal" class="vh-fav-modal">
    ...
    <div class="vh-fav-dialog">
        <div class="vh-fav-header color-bg">
            <span id="vhPointModalTitle">Ajouter un petit déjeuner</span>
        ...
        <div class="vh-fav-body">
            <form id="vhPointForm" method="POST" class="vh-fav-form">
                ...
                <label class="vh-fav-label">Libellé du petit déjeuner</label>
                <input type="text"
                       name="libelle"
                       id="vhPointLibelle"
                       maxlength="100"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    openBtn.addEventListener('click', function () {
        form.action = "{{ route('hoost.dejeuners.store') }}";   // route POST
        methodInput.value = "POST";
        title.textContent = "Ajouter un petit déjeuner";
        libelleInput.value = "";
    ...
    document.querySelectorAll('.vh-edit-point').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            form.action = "/hoost/dejeuners/" + id;   // route update
            methodInput.value = "PUT";

            title.textContent = "Modifier le petit déjeuner";
