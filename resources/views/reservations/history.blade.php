...
@section('section')
    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-title fl-wrap">
                <div class="dashboard-title-item"><span>Mes séjours passés</span></div>
                                                    ...
                                                    @if($reservation->statut === 'PAYE')
                                                        <li>
                                                            <a href="#"
                                                               ...
                                                               data-microtip-position="top-left"
                                                               data-tooltip="Avis"
                                                               data-logement-id="{{ $reservation->logement_id }}">
    ...
    <div id="vh-fav-modal" class="vh-fav-modal">
        ...
        <div class="vh-fav-dialog">
            <div class="vh-fav-header color-bg">
                ...
                {{-- Tu pourras changer ici par "Laisser un avis" si tu veux --}}
            ...
            <div class="vh-fav-body">
                ...
                <form method="POST" action="{{ route('hoost.commentaires.store') }}" class="vh-fav-form">
                    @csrf
                    {{-- ID du logement alimenté par le JS --}}
                    <input type="hidden" name="logement_id" id="vhFavLogementId">
                    <input type="number" name="note" class="vh-fav-input"
                        placeholder="Vôtre note" required>

                    <textarea type="text" name="commentaire" maxlength="255" class="vh-fav-input"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Clic sur le bouton "Avis" (class .fav-open)
