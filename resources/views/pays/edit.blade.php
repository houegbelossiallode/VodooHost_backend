    ...
    <div class="dashboard-content">
        ...
        <div class="container dasboard-container">
            ...
            <div class="dashboard-title fl-wrap">
                <div class="dashboard-title-item"><span>Modification d'un pays</span></div>
            ...
            @endif
            <form method="post" action="{{ route('hoost.pays.update', $pays->id) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="libelle" placeholder="libelle"
                                    value="{{ old('libelle', $pays->libelle) }}"
                                    class="{{ $errors->has('libelle') ? 'is-invalid' : '' }}"
