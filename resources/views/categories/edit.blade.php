                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Modification d'une catégorie</span></div>
                        ...
                        @endif
                           <form method="post" action="{{route('hoost.categories.update',$categorie->id)}}">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="custom-form">
                                        <div class="row">
                                            <div class="col-sm-4">		 
                                                ...
                                                <input type="text" name="libelle" placeholder="libelle" value="{{old('libelle',$categorie->libelle)}}" class="{{ $errors->has('libelle') ? 'is-invalid' : '' }}" style="text-align: left; padding-left: 15px;" />
                                                @error('libelle')
