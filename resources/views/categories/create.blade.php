                ...
                <div class="dashboard-content">
                    ...
                    <div class="container dasboard-container">
                        ...
                        <div class="dashboard-title fl-wrap">
                            <div class="dashboard-title-item"><span>Formulaire de création de catégorie</span></div>
                        ...
                        <div class="dasboard-widget-title fl-wrap" id="sec1">
                            <h5><i class="fa fa-gear"></i> Création d'une catégorie</h5>
                        </div>
                        ...
                        @endif
                           <form method="post" action="{{route('hoost.categories.store')}}">
                            @csrf
